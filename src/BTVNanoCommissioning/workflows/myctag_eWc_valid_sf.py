...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process_shift(self, events, shift_name):
        ...
        iso_ele = events.Electron[
            ...
            (events.Electron.pt > 34) & ele_cuttightid(events, self._campaign)
        ]
        ...
        iso_eindx = ak.mask(
            ...
            ((events.Electron.pt > 34) & ele_cuttightid(events, self._campaign)) == 1,
        )
        ...
        dilep_ele = events.Electron[
            ...
            (events.Electron.pt > 15) & ele_cuttightid(events, self._campaign)
        ]
        req_dilepveto = (
        ...
        req_mtw = (
            np.sqrt(2 * iso_ele.pt * MET.pt * (1 - np.cos(iso_ele.delta_phi(MET))))
            > mtw_threshold
        )
