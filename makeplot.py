...
systs = {"mu22":['nominal', 'puweightUp', 'puweightDown', 'mu_IDUp', 'mu_IDDown', 'mu_IsoUp', 'mu_IsoDown', 'JESUp', 'JESDown', 'UESUp', 'UESDown', 'JERUp', 'JERDown'],
         ...
         "mu24":['nominal', 'UEPS_ISRDown', 'aS_weightDown', 'scalevar_muRDown', 'UEPS_FSRDown', 'scalevar_muR_muFUp', 'aS_weightUp', 'scalevar_muRUp', 'PDFaS_weightUp', 'puweightDown', 'PDF_weightDown', 'PDF_weightUp', 'scalevar_muFDown', 'scalevar_muFUp', 'UEPS_FSRUp', 'ttbar_weightDown', 'PDFaS_weightDown', 'puweightUp', 'scalevar_muR_muFDown', 'UEPS_ISRUp', 'ttbar_weightUp', 'JESUp', 'JESDown', 'JERUp', 'JERDown'],
         "e24":['nominal', 'puweightDown', 'PDF_weightDown', 'UEPS_FSRUp', 'PDFaS_weightDown', 'scalevar_muR_muFUp', 'scalevar_muRDown', 'UEPS_FSRDown', 'scalevar_muR_muFDown', 'aS_weightDown', 'UEPS_ISRDown', 'PDFaS_weightUp', 'scalevar_muFDown', 'UEPS_ISRUp', 'scalevar_muRUp', 'ttbar_weightDown', 'scalevar_muFUp', 'aS_weightUp', 'PDF_weightUp', 'puweightUp', 'ttbar_weightUp', 'JESUp', 'JESDown', 'JERUp', 'JERDown']
     }
